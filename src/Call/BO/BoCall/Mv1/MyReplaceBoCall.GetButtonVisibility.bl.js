...
var visible = true;
var bCallIsReadOnly = me.isReadOnly(Framework.getProcessContext().isPreviewOnly);
...
switch (token) {
  case "btnCalculator":
    visible = (me.getLuCustomer().getRecordTypeName() === "Canada Account" ) && (!bCallIsReadOnly);
    break;
  ...
  case "btnCreateNewCustomerTask":
  case "btnCreateNewFollowUpVisit":
    visible = !bCallIsReadOnly;
    break;
    
  case "btnExecute":
    visible = !(me.getClbStatus() === "Completed" || me.getClbStatus() === "Abandoned" || !bCallIsReadOnly);
    break;
