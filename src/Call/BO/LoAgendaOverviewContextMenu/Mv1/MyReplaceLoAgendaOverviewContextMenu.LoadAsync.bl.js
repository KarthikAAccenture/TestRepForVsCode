...
var myCallStatus = dicJsonQuery.myCallStatus;
...
var bCallIsReadOnly = clbStatus === "Completed" ||  clbStatus === "Abandoned";
...
.then(function(dataAvailable) // <!-- SF/CASDIF End -->
  ...
  var menuEntry0 = {
    "id" : "0000001",
    "actionImg" : "EyeGrey24Inv",
    "actionId" : clbStatus ==="Completed" ? "Review_Visit" : "Preview_Visit",
    "processEvent" : "Preview",
  ...
  var menuEntry8 = {
    "id" : "0000009",
    "actionImg" : "NoteDarkGrey24Inv",
    "actionId" : "Notes",
    "processEvent" :"Notes",
    "actionVisible" : isFollowUpCard === true ? "1" : "0",
    "actionEnabled" : "1"
  };
  ...
  if(Utils.isSfBackend())
  {
    menuEntry2.actionEnabled = menuEntry2.actionEnabled == "1" && dataAvailable == "1"  ? "1" : "0";
    menuEntry3.actionEnabled = Utils.isDefined(dicJsonQuery.bpaMainPKey) && !Utils.isEmptyString(dicJsonQuery.bpaMainPKey) ? "1" : "0";
    menuEntry7.actionEnabled = Utils.isDefined(dicJsonQuery.bpaMainPKey) && !Utils.isEmptyString(dicJsonQuery.bpaMainPKey) ? "1" : "0";
  }
  ...
  if (bCallIsReadOnly) {
    ...
    menuEntry8.actionEnabled = "0";
  }

  //Users to see the 'Delete' option in context menu
  if(myCallStatus === "InProgress" || myCallStatus === "Completed") {
    menuEntry5.actionEnabled = "1";
  } 
