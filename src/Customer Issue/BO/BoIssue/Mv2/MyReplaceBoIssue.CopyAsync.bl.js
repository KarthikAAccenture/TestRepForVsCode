 ...
 * @returns promise
 */
function replaceCopyAsync(originalObject, ownerBpaMainPKey, substitutedUsrPKey, isManagedCustomer, clbMainPKey){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
jsonParams.push({"field" : "initiationDate","value" : Utils.createAnsiDateTimeToday()});
jsonParams.push({"field" : "productPkey","value" : originalObject.getProductPkey()});
jsonParams.push({"field" : "priority","value" : originalObject.getPriority()});
jsonParams.push({"field" : "featureDescription","value" : originalObject.getFeatureDescription()});
