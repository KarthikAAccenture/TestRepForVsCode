 ...
 * @function myGetAllCustomerTasksForCard
 * @this LoMyIssueAlerts
 * @kind listobject
 * @async
 * @namespace CUSTOM
 ...
 * @returns promise
 */
function myGetAllCustomerTasksForCard(numberOfListItems, currentCustomerPKey){
    var me = this;
    ///////////////////////////////////////////////////////////////////////////////////////////////
    //                                                                                           //
...
if (Utils.isSfBackend()){
  jsonQuery.cond = " AND issuePhase IN ('initial', 'Released', 'In Progress', 'Committed' , 'Completed' , 'Declined' , 'Pending' , 'Final' , 'Cancelled' ,'Not Started' , 'Open') AND Account_Task__c.Due_Date__c <> #minDate# AND Account_Task__c.Due_Date__c <= #dateTimeToday# ";
...
jsonParams.push({"field" : "isAlert", "value" : '1'});
